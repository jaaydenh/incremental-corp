...
export default class Company {
    constructor (data, engine, player) {
        ...
        if (this._player.isCompanyEnabled(this._name)) {
            ...
            this.openButton = new OpenButton(20, this._top_margin + this.y_offset, 540, 60, this._name, this._starting_cost, true);
    ...
    openCompany() {
        this.progressBar = new ProgressBar(120, this._top_margin + this.y_offset, 260, 40, this._starting_income, this._speed);
        this.progressBar.handler = this.progressCompleted.bind(this);
        this._engine.gameObjects.push(this.progressBar);

        this.produceButton = new ProduceButton(20, this._top_margin + this.y_offset,  80, 80, this._name, this._img_name);
        this.produceButton.handler = this.produceButtonPress.bind(this);
        this._engine.gameObjects.push(this.produceButton);

        this.buyButton = new BuyButton(120, 55 + this._top_margin + this.y_offset, 260, 40, this._starting_cost * this._cost_multiplier);
        ...
        if (!this._player.isManagerHired(this._name)) {
            this.managerButton = new ManagerButton(400, this._top_margin + this.y_offset, 160, 80, this._manager_cost, true);
    ...
    buyButtonPress () {
        if (this._player.money >= this.buyButton.cost) {
            ...
            this.progressBar.drawBackground(this._engine.context2D);
